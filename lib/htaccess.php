 ...
 *
 * Rewrite:
 *   /wp-content/themes/themename/stylesheets/  to /stylesheets/
 *   /wp-content/themes/themename/javascripts/  to /javascripts/
...
if (stristr($_SERVER['SERVER_SOFTWARE'], 'apache') || stristr($_SERVER['SERVER_SOFTWARE'], 'litespeed') !== false) {
  ...
  function roots_add_rewrites($content) {
    ...
    $roots_new_non_wp_rules = array(
      'assets/stylesheets/(.*)'      => THEME_PATH . '/assets/stylesheets/$1',
      'assets/javascripts/(.*)'       => THEME_PATH . '/assets/javascripts/$1',
      'assets/images/(.*)'      => THEME_PATH . '/assets/images/$1',
